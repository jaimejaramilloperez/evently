...
namespace Evently.Modules.Users.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260210202824_AddOutboxConsumerTable")]
    partial class AddOutboxConsumerTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evently.Modules.Users.Domain.Permissions.Permission", b =>
                {
            ...
            modelBuilder.Entity("Evently.Modules.Users.Domain.Roles.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("role_permissions", b =>
                {
                    b.HasOne("Evently.Modules.Users.Domain.Permissions.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Evently.Modules.Users.Domain.Roles.Role", null)
                        .WithMany()
